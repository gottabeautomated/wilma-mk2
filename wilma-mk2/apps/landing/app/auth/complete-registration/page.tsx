...
export default function CompleteRegistrationPage() {
  ...
  const [step, setStep] = useState<'profile'|'migration'|'welcome'>('profile');
      ...
      <div className="bg-white/70 backdrop-blur-lg rounded-xl shadow-xl p-8 border border-rose-100 max-w-md w-full">
        ...
        <form onSubmit={handleSubmit(onSubmitProfile)} className="space-y-4">
          ...
          <div>
            ...
            />
            {errors.wedding_date && (
              <p className="text-red-500 text-sm mt-1">{errors.wedding_date.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.partner_name && (
              <p className="text-red-500 text-sm mt-1">{errors.partner_name.message}</p>
            )}
          </div>
