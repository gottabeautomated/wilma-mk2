          ...
          <div className="auth-form-container">
            <div className="auth-toggle">
              <button 
                ...
                onClick={() => { setIsLogin(true); setSuccess(false); setServerError(null); reset(); }}
                type="button"
              >
                Anmelden
              </button>
              <button 
                className={`toggle-button ${!isLogin ? 'active' : ''}`}
                onClick={() => { setIsLogin(false); setSuccess(false); setServerError(null); reset(); }}
                type="button"
              >
                Registrieren
              </button>
            ...
            {success && !isLogin ? (
              <div className="bg-white/60 backdrop-blur-lg rounded-xl shadow-xl p-6 text-center border border-rose-100">
              ...
              <form onSubmit={handleSubmit(onSubmit)} aria-busy={loading}>
                ...
                <div className="form-group">
                  ...
                  {errors.password && <div className="text-red-600 text-sm mt-1">{errors.password.message as string}</div>}
                </div>
                {!isLogin && (
                  <div className="form-group">
                    ...
                    {errors.passwordConfirm && <div className="text-red-600 text-sm mt-1">{errors.passwordConfirm.message as string}</div>}
                  </div>
                )}
                {isLogin && (
