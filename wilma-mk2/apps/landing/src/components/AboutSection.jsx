    ...
    return (<section id="about" className="about-section">
      ...
      <div className="container">
        ...
        <div className="team-grid">
          {teamMembers.map((member, index) => (<div key={index} className="team-card-container">
              <div className={`team-card ${flippedCard === index ? 'flipped' : ''}`} onClick={() => handleCardClick(index)} style={{ '--member-color': member.color }}>
                {/* Front of card */}
                <div className="card-front">
                  ...
                  <div className="member-expertise">
                    {member.expertise.map((skill, skillIndex) => (<span key={skillIndex} className="expertise-tag">
                        {skill}
                      </span>))}
                  </div>
                ...
                <div className="card-back">
                  <div className="member-avatar back">
                    {member.name === "Jonas Behrmann" ? (<img src="/JB_landing_portrait.png" alt="Jonas Behrmann" style={{ width: '120px', height: '120px', borderRadius: '50%', objectFit: 'cover', objectPosition: 'center top', boxShadow: '0 6px 24px rgba(0,0,0,0.18)', marginTop: '12px', background: 'none' }}/>) : (member.image)}
                  </div>
                  ...
                  <ul className="achievements-list">
                    {member.achievements.map((achievement, achievementIndex) => (<li key={achievementIndex} className="achievement-item">
