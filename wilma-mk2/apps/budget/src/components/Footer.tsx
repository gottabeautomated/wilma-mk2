...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-primary-50 via-white to-primary-100 border-t border-undertone mt-16">
      {/* Elegant Top Border */}
      ...
      <div className="container mx-auto px-6 py-16">
            ...
            <div className="space-y-3">
              {footerLinks.map((link, index) => (
                ...
                >
                  <a 
                    href={link.href}
                    className="flex items-center space-x-3 text-royal hover:text-graphite transition-all duration-300 group"
                  >
                    <ElegantIcon 
                      name={link.icon} 
                      className="group-hover:text-graphite transition-colors" 
                      size={14} 
                    />
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="card-elegant text-center transition-all duration-300 hover:shadow-golden group"
                ...
                >
                  <ElegantIcon 
                    name={social.icon} 
                    className="text-royal group-hover:text-graphite transition-colors mx-auto mb-2" 
                    size={20} 
                  />
        ...
        <motion.div 
          className="border-t border-undertone mt-12 pt-8"
          initial={{ opacity: 0 }}
