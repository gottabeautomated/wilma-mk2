...
export const ConsentDemo = () => {
    ...
    return (<div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="card-elegant p-8 space-y-6">
          ...
          <div>
            ...
            <input type="email" value={testEmail} onChange={(e) => setTestEmail(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-royal focus:border-transparent" placeholder="test@example.com"/>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <button onClick={handleCheckStatus} className="btn-outline flex items-center justify-center space-x-2">
              <ElegantIcon name="search" className="w-5 h-5"/>
              <span>Status prüfen</span>
            </button>

            <button onClick={handleOptOut} className="btn-secondary flex items-center justify-center space-x-2">
          ...
          {consentStatus && (<div className="section-elegant p-6">
          ...
          <div className="text-center pt-6 border-t">
            <a href="#/" className="btn-outline inline-flex items-center space-x-2">
      ...
      {/* Consent Modal */}
      <ConsentModal isOpen={showModal} email={testEmail} onConsentGiven={handleConsentGiven} onDecline={() => setShowModal(false)}/>
