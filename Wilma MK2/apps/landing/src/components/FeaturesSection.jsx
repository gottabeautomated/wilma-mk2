...
export default function FeaturesSection() {
    ...
    return (<section id="features" ref={sectionRef} className="features-section">
      <style jsx>{`
        .features-section {
          padding: 8rem 2rem;
      ...
      <div className="container">
        ...
        <div className="features-grid">
          ...
          <div className="features-nav">
            {features.map((feature, index) => (<button key={feature.id} className={`nav-item ${activeFeature === index ? 'active' : ''}`} onClick={() => setActiveFeature(index)}>
          ...
          <div className="feature-content">
            {features.map((feature, index) => (activeFeature === index && (<div key={feature.id} className="feature-card" style={{
                ...
                '--feature-bg': feature.bgColor.replace('bg-gradient-to-br', 'linear-gradient(135deg,').replace('from-', '').replace('to-', ', ')
                  ...
                  <div className="benefits-list">
                    {feature.benefits.map((benefit, benefitIndex) => (<div key={benefitIndex} className="benefit-item">
