        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-pearl-600">
              Erstelle deine Location aus einer Handskizze
            </p>
          </div>
      ...
      >
        <div className="flex items-center justify-center h-96">
          <div className="text-center">
            <MapPin className="w-16 h-16 text-pearl-300 mx-auto mb-4" />
            <h3 className="text-lg font-semibold text-pearl-700 mb-2">
              Venue Editor wird entwickelt
            </h3>
            <p className="text-pearl-500">
              Der Venue-Editor wird bald verfügbar sein
            </p>
          </div>
        </div>
      </motion.div>
