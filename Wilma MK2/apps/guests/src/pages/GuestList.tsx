...
import { Plus, Download, Upload, Users, CheckCircle, Clock, XCircle } from 'lucide-react'
...
const GuestList: React.FC = () => {
  ...
  const handleGuestImport = async (importedGuests: Guest[]) => {
    if (!currentWedding) return
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <CSVExportDialog
        ...
        guests={guests}
        weddingName={currentWedding.venue_name || 'Hochzeit'}
      />
    </div>
  )
}
