...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="fixed left-0 top-0 h-full w-64 bg-white border-r border-undertone shadow-elegant overflow-y-auto">
      <div className="p-6 pt-20">
        ...
        <motion.div
          ...
          className="mt-8 pt-8 border-t border-undertone"
        >
