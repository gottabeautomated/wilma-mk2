...
const Header: React.FC = () => {
  return (
    <header className="bg-white border-b border-undertone px-6 py-4 shadow-elegant">
      <div className="flex items-center justify-between">
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-softrose border border-undertone rounded-lg focus:outline-none focus:ring-2 focus:ring-royal focus:border-transparent transition-all duration-200"
            />
          </div>
        </motion.div>
        ...
        >
          ...
          {/* Profile */}
          <button className="flex items-center space-x-2 p-2 rounded-lg hover:bg-softrose transition-colors duration-200">
            <div className="w-8 h-8 bg-royal rounded-full flex items-center justify-center">
              <User className="w-4 h-4 text-white" />
            </div>
            <span className="text-sm font-medium text-graphite">Emma & Max</span>
          </button>
        </motion.div>
      </div>
    </header>
